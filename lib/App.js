...
class App {
    ...
    constructor(locname = `App.js`) {
        ...
        const app = {
            player1: "X",
            player2: "Y",
            id: { start: this.startID, moves: this.moveID, event: this.eventTypeId, },
            traces: {
                location: locname,
            ...
            log: { console: this.logLevel, stderr: this.errorLevel,},
            /** @type {Game|undefined} */
            game: new Game(),
            ui: {
        ...
        try {
            this.newGame = new Game(app.player1, app.player2, app.log.console, app.traces.game);
