...
class App {
     ...
     * @date 2023/03/27 @version 0.4.0 created at
    onExit() {
     ...
     * @version 0.4.0  FREEZE @date 2023/03/25. GitHub [#8](https://github.com/iPoetDev/terni-lapilli--toe/issues/8)
     */
     ...
     * @date 2023/03/22 @version 0.3.0 DONE
     * @date 2023/03/27 @version 0.4.0 SNAPSHOT
      */
    ...
    /* eslint-disable-next-line valid-jsdoc */
    /** appLogger @todo [ ] TODO INSPECT REMOVE THIS B4 SUBMISSION
     * @function appLogger
     * @kind function
     ...
     * @param {number} [locname] @default this.fileName
     * @memberof App
     * @date 2023/02/22 @version 0.3.0 INSPECT @date 2023/03/22. See Changelog on this date.
     * @date 2023/03/27 @version 0.4.0 SNAPSHOT
     */
