 // @ts-check
/** Game.js 001 Module @version 0.5.0 @date 2023/04/13
 ...
 * @date 2023/04/10 @version 0.5.0 Bump. Significant Code/Critcial Path change.
                    Poor Proxy for a Deterministic Finite State Machine and Controller/ State Management
 ...
 * @prop {object} STATES STATES Constants/Flags @interface @kind member @public
...
class Game {
    ...
    STATES = {
        game: {
            ...
            NOSTART: "NOSTART", // Alias to initial, or just post initialisation => Button states
            NOTSTARTED: "NOSTARTED", // Failed to start => Button states
            START: "START", // Game starts => Button states
            STARTED: "STARTED", // Game commenced => Button states
    ...
    constructor(_X = "X", _O = "O", log = 0, filename = `Game.js`) {
        ...
        this.currentPiece = this.Player1;
    ...
    onInit(isRunning = "RUN", log = this.logLevel, locname = `${this.fileName}: onInit`) {
        ...
        try {
            ...
            this.gamePieces.currentPiece = this.currentPiece;
    ...
    /** isGameStarted @version 0.5.0 @date 2023/04/13
    ...
    /**
     * checkMove @version 0.5.0 @date 2023/04/13 @TODO REMOVE DEFAULT FOR VALIDMOVE
     ...
     * @version 0.5.0 @date 2023/04/13: Bump
     */
    ...
    /** makeMove  @version 0.5.0 @date 2023/04/13
     * @function makeMove
     * @kind function
     ...
     * @version 0.3.1  @date 2023/03/24
     * @version 0.4.1 @date 2023/03/28
     * @version 0.4.2  @date 2023/04/01-02
     * @version 0.5.0  @date 2023/04/13 Bumped. Added Game State Management data object. Needs to be moved out of method. Is critical path. Alterantes: TS Interfaces, types, and enums. Not in scope.
                - Refactored code blocks into closures and helper methods, to improve method length and CC scoring.
                - Improved switch case by using methods not code blocks.
     */
    ...
    makeMove(move, current, isRunning = "RUN", log = this.logLevel, locname = `${this.fileName}: makeMove()`) {
        ...
        window.alert(`Just before state: ${this.currentPiece}`)
