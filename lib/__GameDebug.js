...
class GameDebug {
     ...
     * @param {*} mgs Custom message, with a default value.
     * @param {*} level Debug level, with a default level of 1.
     * @param {*} filename Author provided filename location of debugger, with default filename as a prompt.
     * @version 0.2.0
     * @memberof GameDebug
     */
    _debug(obj, mgs = `Defaults: Log to Console: Level 1`, level = 1, filename = `NoFilename.js`) {
        switch (level) {
            case 1:
            ...
            case 9:
                ...
                console.error(`9: ${filename}  Error: ${obj} `);
