...
class GameLogic {
     ...
     * @version 0.4.2 @date 2023/04/03. Refactored, Message & Trace, Constants. droped `this` keybord in signature, bumped version and JSDoc
     */
     ...
     * @constant ISWIN Truthy @default true
     * @constant NOWIN Flasey @default false
     * @inner isWinningCombo A closure function that assigns the winning combo.
     * @returns {boolean} @constant ISWIN @constant NOWIN
     * @memberof GameLogic
    ...
    isAWin(log = this.logLevel, locname = `${this.fileName}: isAWin`) {
        ...
        // 3: Game is Active: Return false by default, .
        return NOWIN;
    }
     ...
     * @constant ISDRAW Truthy @default true
     * @constant NODRAW Flasey @default false
     * @returns {boolean} @constant ISDRAW @constant NODRAW
     * @memberof GameLogic
     * @version 0.3.0 @date 2023/03/22. See Changelog on this date.
     ...
     * @version 0.3.0 @date 2023/03/22.
     * @version 0.4.2 @date 2023/04/03 Changed sumbol names, created a inner closure, evalTypeErro, bumped version and JSDoc
     */
