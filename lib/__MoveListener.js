    ...
    * @date 2023/04/10 @version 0.5.0 @note #25 Bump of a full minor
    ...
    onClick(cell, game, nodes, log = this.logLevel, locname = `${this.fileName}: onClick`) {
        ...
        const flows = {
            ...
            CONTINUE: game.STATES.moves.CONTINUE,
            TERMINATE: game.STATES.moves.TERMINAL,
        ...
        const outputs = {
            ...
            ERROR: {
                ...
                /**@type {string|Error} */
                inspect: outcome,
                message: `Parse of game.makeMove is ${outcome} has errors ${outcome.toString()}`,
                trace: `${locname}: Is Error: ${outcome instanceof Error} ${outcome.toString()}`,
                console: 9,
            },
        };
        ...
        if (typeof outcome === "string") {
            ...
            if (game.gameRunning === flows.ACTIVE && outcome === flows.CONTINUE) {
                ...
                this.updateOnMove(flows.TARGET, flows.INSTANCE, outcome, outputs.UPDATE.console, outputs.UPDATE.trace);
                return;
            }
            ...
            if (game.gameRunning === flows.INACTIVE && outcome === flows.TERMINATE && typeof outcome === casts.STR) {
                ...
                this.updateAtEnd(flows.GRID, flows.INSTANCE, outcome, outputs.END.console, outputs.END.trace);
                return;
            }
        }
